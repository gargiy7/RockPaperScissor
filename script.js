...
// deciding CPU
  ...
  else if (player === "rock" && cpu === 'scissor') { demo.innerHTML = "PLAYER WON !" }
  //for payer - paper
  else if (player === "paper" && cpu === 'scissor') { demo.innerHTML = "CPU WON" }
  else if (player === "paper" && cpu === 'rock') { demo.innerHTML = "PLAYER WON !" }
  //for payer - scissor
  else if (player === "scissor" && cpu === 'rock') { demo.innerHTML = "CPU WON" }
  else if (player === "scissor" && cpu === 'paper') { demo.innerHTML = "PLAYER WON !" } 
// main function completed
chance = chance+1;
  console.log(chance);
document.getElementById("demo4").innerHTML ='Chances left: ' + (10-chance);
}